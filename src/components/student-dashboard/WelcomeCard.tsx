...
export const WelcomeCard = () => {
  return (
    <Card className="col-span-full bg-gradient-to-r from-khatam-blue/90 to-blue-500 text-white w-full">
      <CardHeader>
      ...
      <CardContent>
        <p className="text-md md:text-lg">شما ۲ تکلیف در حال انجام و ۳ اطلاعیه جدید دارید.</p>
      </CardContent>
